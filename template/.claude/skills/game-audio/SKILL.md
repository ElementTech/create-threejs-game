---
name: game-audio
description: Web Audio API for game sound effects, music, and spatial audio. Use when implementing game audio, sound effects, background music, or audio feedback in browser-based games.
---
...
This skill provides Web Audio API expertise for creating audio feedback, sound effects, and music in browser-based games.
