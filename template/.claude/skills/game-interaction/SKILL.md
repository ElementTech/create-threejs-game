...
description: Microinteractions, animations, transitions, easing, and feedback systems for game feel. Use when implementing UI animations, game juice, state transitions, or visual feedback in games.
---
